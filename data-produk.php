                ...
                <table border="1" cellspasing="0" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="produk/<?php echo $row['product_image'] ?>" target="_blank"><img src="produk/<?php echo 
                                    $row['product_image'] ?>" width="50px"></a></td>
                            <td> <?php echo ($row['product_status'] == 0) ? 'tidak akhif' : 'aktif'; ?></td>
                            <td>
